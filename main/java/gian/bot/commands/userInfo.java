    ...
    public void onMessageCreate(MessageCreateEvent infoEmbed) {
        try {
            ...
            if (infoEmbed.getMessageContent().equals(Main.Prefix + "WHO AM I?")) {
                ...
                String botID = "824678463390351410";
                String displayID = String.valueOf(infoEmbed.getMessageAuthor().getId());

                if ( displayID == botID) {
                    System.out.println("...");
                } else if (displayID != botID) {
                    long end = System.currentTimeMillis();
                    long elapsed = (end - Main.start) / 1000;
                    System.out.println(e + "\n | Someone did a command through DM | " + String.valueOf(infoEmbed.getMessageContent()));
                    System.out.println("User: " + String.valueOf(infoEmbed.getMessageAuthor().getDisplayName()));
                    System.out.println("ID: " + displayID + "\n" + "sent at..." + elapsed + "." + (end - Main.start) % 1000);
                }
